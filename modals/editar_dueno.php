<script>
    $(document).ready(() => {
        const formulario = document.getElementById("form-edueno");
...
<div class="modal fade" id="editarDueño" tabindex="-1" aria-labelledby="editarDueñoLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editarDueñoLabel">Editar administrador</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="" method="post" id="form-edueno">
...
<!-- Fin modal editar administrador -->