<script>
    $(document).ready(() => {
        const formulario = document.getElementById("form-easistente");
...
<div class="modal fade" id="editarAsistentes" tabindex="-1" aria-labelledby="editarAsistentesLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editarAsistentesLabel">Editar asistente</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="" method="post" id="form-easistente">
